...
const _contactConfig = getSiteConfig();
export const metadata: Metadata = generatePageMeta({
  title: 'Contact ' + _contactConfig.brand.shortName + ' in ' + _contactConfig.location.name,
  description: 'Contact ' + _contactConfig.brand.name + ' for a free cash offer on your ' + _contactConfig.location.name + ' property. Call ' + _contactConfig.brand.phone + ' or fill in our form for a response within 24 hours. No fees, no obligation.',
  path: '/contact',
});
