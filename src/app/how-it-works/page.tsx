...
const _hiwConfig = getSiteConfig();
export const metadata: Metadata = generatePageMeta({
  title: 'How to Sell Your House Fast in ' + _hiwConfig.location.name,
  description: 'How to sell your house fast in ' + _hiwConfig.location.name + '. Our simple 4-step process gets you a guaranteed cash offer within 24 hours. Complete in as little as ' + _hiwConfig.brand.averageDaysToComplete + ' days with no fees.',
  path: '/how-it-works',
});
