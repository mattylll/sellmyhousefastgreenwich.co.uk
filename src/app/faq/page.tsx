...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return generatePageMeta({
    title: 'FAQ: Selling Your House Fast in ' + config.location.name,
    description: 'Frequently asked questions about selling your house fast in ' + config.location.name + ' for cash. Answers about our process, fees, timelines and how we buy properties across ' + config.location.region + '.',
    path: '/faq',
  });
}
