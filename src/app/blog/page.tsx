...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return generatePageMeta({
    title: config.location.name + ' Property Blog',
    description: 'Property selling tips, ' + config.location.name + ' market updates, and expert advice on selling your house fast in ' + config.location.region + '. Read our latest articles.',
    path: '/blog',
  });
}
