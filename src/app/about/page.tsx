...
const _aboutConfig = getSiteConfig();
export const metadata: Metadata = generatePageMeta({
  title: 'About ' + _aboutConfig.brand.shortName,
  description: 'About ' + _aboutConfig.brand.name + ' - trusted cash house buyers in ' + _aboutConfig.location.name + '. Over ' + _aboutConfig.brand.yearsExperience + ' years helping ' + _aboutConfig.location.region + ' homeowners sell fast for cash. No fees, no chains.',
  path: '/about',
});
