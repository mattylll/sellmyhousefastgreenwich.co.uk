...
const _areasConfig = getSiteConfig();
export const metadata: Metadata = generatePageMeta({
  title: 'Areas We Buy Houses in ' + _areasConfig.location.name,
  description: 'We buy houses for cash across ' + _areasConfig.location.name + ' and ' + _areasConfig.location.region + ' including ' + _areasConfig.location.neighborhoods.slice(0, 3).join(', ') + ' and more. Get a free cash offer on your property today.',
  path: '/areas',
});
