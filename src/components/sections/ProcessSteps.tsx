...
import { FileText, PoundSterling, CalendarDays, Banknote } from 'lucide-react';
      ...
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          <p className='text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto leading-relaxed'>
            Selling your house has never been easier. Our simple 4-step process gets you a guaranteed cash offer fast.
          </p>
        </motion.div>
