...
export default function TrustBadges() {
  ...
  const configBadges = config.content.trustBadges;

  // If config provides trust badges, use them as guarantees; otherwise use defaults
  const guarantees = configBadges && configBadges.length > 0
