...
export default function CTASection() {
  ...
  const ctaConfig = config.content.cta || config.content.ctaContent;
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight">
              {ctaConfig?.heading ? (
                ...
                <>Ready to Sell Your{' '}<span className="text-accent">House Fast?</span></>
              )}
            </h2>
            ...
            <div className="relative bg-card/95 backdrop-blur-sm rounded-2xl shadow-2xl shadow-black/30 border border-border/50 p-8 md:p-10">
              ...
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-foreground">
                  {ctaConfig?.buttonText || 'Get Your Free Cash Offer'}
                </h3>
