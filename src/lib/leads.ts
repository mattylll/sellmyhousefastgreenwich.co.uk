...
export async function submitLead(
  ...
  const webhookUrl = config.leads.ghlWebhookUrl;

  // Build normalised payload — GHL gets the same field names regardless of form
  ...
  // Strip undefined values so GHL doesn't get "undefined" strings
  ...
  // If webhook is still a placeholder, skip the fetch and go straight to fallback
  ...
  // Attempt webhook — retry once on failure
